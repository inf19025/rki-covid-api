...
/**
 * Function for all cases in germany for number of days
 * @param days The number of days to get the cases for
 * @returns The promise containing the response
 */
export async function GermanyAllCasesHistoryResponse(
	days?: number
): Promise<GermanyHistoryData<{ cases: number; date: Date }>> {
